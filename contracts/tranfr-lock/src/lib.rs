...
// codes, types, and since_cmp functions by name.
...
#[cfg(feature = "library")]
pub use main::{
    load_and_parse_args, load_and_parse_witness, parse_tranfr_args, parse_tranfr_witness_lock,
    TranfrArgs, TranfrWitness, UnlockMode, ARGS_LEN, WITNESS_LOCK_LEN,
};
#[cfg(feature = "library")]
pub use main::{
